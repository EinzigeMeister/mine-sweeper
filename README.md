...
## Where Do I Start? (Complete)

### Removing Existing Git Configuration (Complete)

### Creating Your Own Git Repo (Complete)

## Generating Your Pipenv (Complete)

## Generating Your Database (Relationships/ForeignKeys)
